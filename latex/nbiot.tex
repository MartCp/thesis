...
\section{Parking - a realistic use case} %%HH refactor
...
\section{System design} %%HH move up to right after introduction of nbiot "dive into etc"
...
\subparagraph{Coap} %%HH remove if we end up not using this package
